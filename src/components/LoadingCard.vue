  ...
  <section class="mb-6 rounded-2xl border border-slate-200 bg-white p-6">
    ...
    <div class="mt-6 space-y-3">
      ...
      <div class="grid gap-3 md:grid-cols-3">
        ...
        <div class="h-32 animate-pulse rounded-xl bg-slate-100" style="animation-delay: 150ms" />
        <div class="h-32 animate-pulse rounded-xl bg-slate-100" style="animation-delay: 300ms" />
      </div>
    </div>
  </section>
</template>
